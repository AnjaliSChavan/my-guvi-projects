...
icon = Image.open(r"C:\Users\Anjali\PycharmProjects\phone-pe.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Anjali",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Anjali*!
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(
                r'C:\Users\Anjali\Downloads\Statenames.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/AnjaliSChavan/my-guvi-projects")
