...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\Anjali\AppData\Local\Programs\Python\Python311")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"ANJALI CHAVAN"}')
    mail = (f'{"Mail :"}  {"anjalisandipchavan@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "Youtube": "https://youtu.be/zSHhbbkMGVM",
        "GITHUB": "https://github.com/AnjaliSChavan",
        "LINKEDIN": "https://www.linkedin.com/in/anjali-chavan-a685ba169/"}

    col1, col2 = st.columns(2)
    col1.image(Image.open("C:\\Users\Anjali\\Downloads\\New Doc 05-25-2020 09.24.46.jpg"), width=400)
