...
icon = Image.open("C:\\Users\\Anjali\\OneDrive\\Desktop\\Youtube.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Anjali Chavan",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Anjali Chavan!*"""})

# CREATING OPTION MENU
with st.sidebar:
    selected = option_menu(None, ["Home","Harvest & transform","View"],
...
# BUILDING CONNECTION WITH YOUTUBE API
    api_key = "AIzaSyAdrgO0l7gNtyP6gAChLQoRHAgXPoJa5TY"  # "AIzaSyAdrgO0l7gNtyP6gAChLQoRHAgXPoJa5TY"
...
if selected == "Home":
    # Title Image
    #st.image("C:\\Users\\Anjali\\OneDrive\\Desktop\\Youtube.png")
    col1,col2 = st.columns(2,gap= 'medium')
    col1.markdown("## :red[Domain] : Social Media")
    col1.markdown("## :pink[Technologies used] : Python,MongoDB, Youtube Data API, MySql, Streamlit")
...
if selected == "Harvest & transform":
    tab1, tab2 = st.tabs(["$\huge 🎥 HARVEST $", "$\huge🚀 TRANSFORM $"])
    ...
    with tab1:
        ...
        if ch_id and st.button("Harvest Data"):
            ...
            st.write(f'#### Harvested data from :green["{ch_details[0]["Channel_name"]}"] channel')
            st.table(ch_details)
